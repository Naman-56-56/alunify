"""
Django settings for alunify project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#&s_9m_c#-#p@ei&)i4(_62n(o(eg96tp+129=z7t9b9zv^+9-')
...
WSGI_APPLICATION = 'alunify.wsgi.application'
